...
Les paramètres, leur nombre et leur taille n'ont de limites que de l'ordre de la dizaine de Ko. Il faut donc pouvoir y accéder. Le paramètre \code{\$0} est le nom du script parfois avec le nom du répertoire. Les neufs suivants sont nommés \code{\$1}, ..., \code{\$9}. Pour accéder aux autres il faut ruser un peu.
