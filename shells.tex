...
\nicepicture{diagrammes/ShellUnix.png}{shell \unix}{le WEB, ouvrages divers}
...
\leftpicture{diagrammes/shell-main-states.png}{ \shell{} : fonctionnement général}{créé avec \emph{yEd}}
L'exécution d'un programme suit l'algorithme :
\rightpicture{diagrammes/shell-exec.png}{ \shell{} : exécution d'un programme}{créé avec \emph{yEd}}
